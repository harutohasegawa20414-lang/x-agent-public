...
[
  {{
    ...
    "description": "この型を使うとどんな投稿文になるかを具体的に40〜50文字で説明（例: 商品名を挙げて再販を告知するシンプルな投稿になります）。必ず「〜投稿になります」で終えること。",
    "template": "[プレースホルダー]は使わず、この型で実際に投稿されそうなリアルな例文を1つ書く（例: ついに最終回！まさかの展開に…【マイクラ】実況プレイ #24 https://t.co/xxxxx @YouTubeより）"
  }},
  ...
]
必ず10個返すこと。"""
