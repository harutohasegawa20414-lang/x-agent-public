...
import { fetchSourceSelections, saveSourceSelections, fetchUrlContent } from '../api'
...
export default function SourceSelector({ onClose, onSaved }) {
    ...
    useEffect(() => {
        const load = async () => {
            setLoading(true)
            try {
                const selRes = await fetchSourceSelections()
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await saveSourceSelections(selectedUrls)
